...
branch main: branch estável, backend sem conexão de banco de dados
...
Essa pasta contém o backend sem conexão de banco de dados conectado com banco de dados SQLite.
